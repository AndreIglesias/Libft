...
#    Updated: 2020/10/21 16:56:02 by ciglesia         ###   ########.fr        #
#                                                                              #
#******************************************************************************#
...
DIRSRC		=	.
DIRPRTF		=	./ft_printf/src/
DIRPRTF_A	=	$(DIRPRTF)/aux/
...
SRCP		=	ft_printf.c caster.c ft_vfprintf.c id_format.c interpreter.c manipulation.c

SRCPAUX		=	ft_put.c print_address.c ft_strrevf.c ft_putdbl.c printform.c ft_putoxx.c ft_itoa_basexx.c

OAUX		=	$(SRC:%=$(DIROBJ)%) $(SRCP:%=$(DIROBJ)%) $(SRCPAUX:%=$(DIROBJ)%)
DEPS		=	$(OAUX:.c=.d)
OBJS		=	$(OAUX:.c=.o)
