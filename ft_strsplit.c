...
/*   Updated: 2019/08/13 20:41:04 by ciglesia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int		ft_count_words(char *str, int spos, int cont, char c)
{
...
static char		**ft_decompose(char **tab, char *str, int spos, char c)
{
	int letrs;
	int i;
	int tpos;
